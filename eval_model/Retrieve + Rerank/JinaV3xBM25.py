...
class BM25JinaV3Retriever:
    def __init__(self, alpha=0.7,
        ...
        self.k1 = 1.2
        self.b = 0.75
        # Khởi tạo mô hình Jina Embeddings v3
    ...
    def index_corpus(self, corpus):
        ...
        print("Encoding corpus with Jina Embeddings v3...")
    ...
    def retrieve(self, queries, top_k=10, rerank_top_k=100):
        ...
        results = {}
        print("Encoding queries with Jina Embeddings v3...")
...
def evaluate_bm25_jina_with_reranker(data_path, alpha_values=[0, 0.3, 0.5, 0.7, 1.0], k_values=[1, 3, 5, 10, 100], use_reranker=False):
    ...
    print(f"\n=== Kết quả đánh giá BM25 và Jina Embeddings v3 {reranker_status} ===")
    
    for alpha in alpha_values:
        print(f"\n=== Đánh giá với alpha = {alpha} {reranker_status} ===")

        retriever = BM25JinaV3Retriever(alpha=alpha, use_reranker=use_reranker)
...
def compare_with_without_reranker(data_path, alpha_values=[0, 0.3, 0.5, 0.7, 1.0], k_values=[1, 3, 5, 10, 100]):
    ...
    evaluate_bm25_jina_with_reranker(
        data_path=data_path,
